...
Tracking vendor outreach, NDAs, and proposals for the WindhorseTour website retheme RFP.

## Vendor pipeline

| Vendor | NDA | Proposal | Notes |
|--------|-----|----------|-------|
| [OSMOS](vendors/osmos.md) | Vendor signed 2026-06-15 | Not received | First to sign NDA; zip v1 sent via Slack 2026-06-15 |
| [Sharjeel Ahmad](vendors/sharjeel-ahmad.md) | Vendor signed 2026-06-16 | Not received | Reddit · Codeable Q20–Q24 · awaiting zip delivery |
...
Executed NDAs and related artifacts live under `documents/nda/`.
